<template>
  <view class="game-page">
    ...
    <view class="elapsed-timer-section" v-if="(gameMode === 'simple' || gameMode === 'rounds') && showTimer">
...
function checkMatchWin() {
  ...
  if (player1Wins.value >= requiredWins) {
    ...
    score2.value = 0
    currentPlayer.value = 0
    uni.showToast({ title: `第 ${player1Wins.value + player2Wins.value + 1} 局开始`, icon: 'none' })
  }
}
